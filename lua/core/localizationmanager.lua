...
Hooks:Add("LocalizationManagerPostInit", "OrPack_loc", function(...)				
	...
	if Idstring("russian"):key() == SystemInfo:language():key() then
		LocalizationManager:add_localized_strings({
			...
			loading_op_gameplay_37 =						"Штурмовики могут с легкостью подавлять врагов, предоставляя защиту своим напарникам. Враги, находящиеся под подавлением, забудут про свое текущее задание, будут хуже стрелять или вовсе постараются вас избежать.",
			...
			loading_op_gameplay_40 =						"Если вы будете играть в дни выхода PAYDAY 2 и PAYDAY: The Heist, то сможете приобрести Классческие контракты.",
			...
			loading_op_gameplay_46 =						"На сложности Жажда Смерти и выше вам будут встречаться Отряды Клокеров. Держитесь вместе и никого не оставляйте позади.",
			...
			loading_op_gameplay_50 =						"На уровнях сложности выше OVERKILL охранники и гражданские будут могут услышать речь грабителей при скрытном прохождении.",
			...
			loading_op_gameplay_59 =						"Призрак - мастер скрытности. Однако, он также крайне способен в ближнем бою и может скрытно выполнять задания, пока его команда отвлекает врагов.",
			...
			loading_op_gameplay_62 =						"Играйте осторожно и не торопитесь. Не стеснятесь отступать в безопасное место, если ситуация выходит из под контроля.",
			...
			loading_op_gameplay_68 =						"Лучше иметь разделенные роли в команде, чем когда каждый будет пытаться делять все понемногу.",
			loading_op_gameplay_69 =						"Самый очевидный подход не всегда самый лучший.",
			loading_op_gameplay_70 =						"Отвлекайте врагов огнем, во время того, как вашего напарника поднимают.",
